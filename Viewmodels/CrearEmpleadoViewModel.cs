...
namespace SVV.ViewModels
{
    public class CrearEmpleadoViewModel
    {
        ...
        public bool ColaboradorRemoto { get; set; } = false; // Cambiar a false por defecto
        [StringLength(150, ErrorMessage = "La ubicación base no puede exceder 150 caracteres")]
